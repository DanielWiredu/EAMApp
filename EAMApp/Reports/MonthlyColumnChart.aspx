<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonthlyColumnChart.aspx.cs" Inherits="EAMApp.Reports.MonthlyColumnChart" %>
    ...
    <div>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <PlotArea>
                <Series>
                    <telerik:ColumnSeries DataFieldY="AMOUNT" >
                        <LabelsAppearance Visible="true" DataField="AMOUNT" DataFormatString="{0:0.00}">
            ...
            <ChartTitle Text="Monthly Payment Chart">
                ...
                <asp:SqlDataSource ID="chartSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="select PAYMONTH, sum(amount) as AMOUNT from tblPayments where Currency = @Currency and Payyear = @Payyear group by PAYMONTH">
                    <SelectParameters>
