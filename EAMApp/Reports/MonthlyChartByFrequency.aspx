<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonthlyChartByFrequency.aspx.cs" Inherits="EAMApp.Reports.MonthlyChartByFrequency" %>
    ...
    <div>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <telerik:RadComboBox ID="dlPayFreq" runat="server" Width="100%" DataSourceID="payFreqSource" DataTextField="PayFreq" DataValueField="PayFreq" Text="Select Frequency"></telerik:RadComboBox>
            ...
            <ChartTitle Text="Monthly Payment Chart">
                ...
                <asp:SqlDataSource ID="chartSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="select PAYMONTH, sum(amount) as AMOUNT from vwPayments where Currency = @Currency and PayFreq = @PayFreq and Payyear = @Payyear group by PAYMONTH">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="dlCurrency" Name="Currency" PropertyName="SelectedValue" />
                        <asp:ControlParameter ControlID="dlPayFreq" Name="PayFreq" PropertyName="SelectedValue" />
