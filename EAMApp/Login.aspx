<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="EAMApp.Login" %>
...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
     ...
     <title>EAM Partners Contribution</title>
    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div>
            <div>
                ...
                <%--<h1 class="logo-name" style="font-size:110px">EAM</h1>--%>
          ...
          <%--  <p>Come and experience Breakthrough Prayer, Worship & Praise, Prophetic Preaching & Teaching, 
            ...
            <img src="Content/img/EAM_Logo.jpg" width="350" height="200" />
            <hr />
            <p>Please enter your username and password.</p>
         <form runat="server" class="m-t" style="width:350px" defaultbutton="btnLogin">
            ...
            <p class="m-t" style="width:350px" > <small>Repositioning God's people through revival for the return of our Lord Jesus Christ. &copy; <%=DateTime.Now.Year.ToString() %> </small> </p>
        </div>
    </div>
