<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="EditPartner.aspx.cs" Inherits="EAMApp.Registration.EditPartner" %>
                        ...
                        <div class="form-group">
                             ...
                             <div class="form-group">
                               ...
                               <div class="col-md-3">
                                    ...
                                    <telerik:RadDropDownList ID="dlCurrency" runat="server" Width="100%" DataSourceID="currencySource" DataTextField="Currency" DataValueField="Currency" Enabled="false"></telerik:RadDropDownList>
