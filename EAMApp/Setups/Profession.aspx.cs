...
namespace EAMApp.Setups
{
    public partial class Profession : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                string query = "insert into tblProfession(Profession) values(@profession)";
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                string query = "update tblProfession set Profession=@profession where ID = '" + ViewState["ID"].ToString() + "'";
                command = new SqlCommand(query, connection);
