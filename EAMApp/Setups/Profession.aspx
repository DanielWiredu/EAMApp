<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="Profession.aspx.cs" Inherits="EAMApp.Setups.Profession" %>
     ...
     <div class="wrapper wrapper-content animated fadeInRight">
                <div class="ibox float-e-margins">
                    ...
                    <ContentTemplate>
                        ...
                        <asp:SqlDataSource ID="professionSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [tblProfession] ORDER BY [ID]" DeleteCommand="DELETE FROM [tblProfession] WHERE [ID] = @ID" UpdateCommand="UPDATE [Profession] SET [Profession] = @Profession WHERE [ID] = @ID" InsertCommand="INSERT INTO Profession(Profession) VALUES (@Profession)">
                            <DeleteParameters>
