...
namespace EAMApp
{
    public partial class Login : System.Web.UI.Page
    {
        ...
        protected void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string query = "select username,userpassword,userroles,active,countryid from tblUsers where UserName = @username";
                ...
                if (reader.Read())
                {
                    ...
                    if (MatchSHA1(hashedPassword, GetSHA1(txtPassword.Text.Trim())))
                    {
                        ...
                        Session["usercountry"] = reader["countryid"].ToString();
