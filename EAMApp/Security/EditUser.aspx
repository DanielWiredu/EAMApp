<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="EditUser.aspx.cs" Inherits="EAMApp.Security.EditUser" %>
                ...
                <div class="ibox float-e-margins">
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-3">
                     ...
                     <div class="col-md-3">
                         <label>Country</label>
                         <telerik:RadComboBox ID="dlCountry" runat="server" Width="100%" DataSourceID="countrySource" DataTextField="CountryName" DataValueField="CountryId" Filter="Contains" MarkFirstMatch="false" Text="Select Country" MaxHeight="200px"></telerik:RadComboBox>
                          <asp:SqlDataSource ID="countrySource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * from tblCountries"></asp:SqlDataSource>  
                          <asp:RequiredFieldValidator runat="server" ErrorMessage="Required Field" ControlToValidate="dlCountry" Display="Dynamic" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                     </div>  
                 </div>
             </div>
                     <div class="form-group">
