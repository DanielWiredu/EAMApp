...
namespace EAMApp.Security
{
    public partial class NewUser : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            string query = "insert into tblUsers(username,userpassword,userroles,fullname,gender,maritalstatus,contactno,email,posttype,address,countryid,active) values(@uname,@upass,@uroles,@fname,@gender,@mstatus,@contactno,@email,@post,@address,@countryid,@active)";
